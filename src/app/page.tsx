...
//             <p style={s.quoteText}>
//               I dealt with cystic acne from age 13 through 26. Three rounds of Accutane. Healthy weight, very active, ate well. Every lab came back normal. Every doctor said the same thing: <em>you're fine.</em>
//             </p>
//             <p style={s.quoteText}>
  ...
  return (
    <div style={s.root}>
      ...
      <section style={s.section}>
        <div style={s.sectionInner}>
          <div style={s.sectionEyebrow}>The problem</div>
          <h2 style={s.sectionTitle}>Medicine is built for populations.<br />Not for you.</h2>
          <p style={s.sectionBody}>
            When you fall outside the average, the system sends you home. So you experiment on yourself—but without structure, you're just drawing conclusions from noise.
          </p>

          <div style={s.problemCards}>
            {[
              { title: 'Too many variables', body: 'Changing five things at once means you learn nothing.' },
              { title: 'No baseline', body: 'Without a starting point, you\'re measuring change against chaos.' },
              { title: 'Hidden confounders', body: 'Stress, sleep, and hormones quietly skew your results.' },
              { title: 'Biological timing', body: 'Bodies take weeks to adapt, but most self-experiments end in days.' },
            ].map((card, i) => (
              <div key={i} style={s.problemCard}>
                <h3 style={s.problemCardTitle}>{card.title}</h3>
                <p style={s.problemCardBody}>{card.body}</p>
      ...
      <section style={{ ...s.section, background: 'rgba(255,255,255,0.02)', borderTop: '1px solid #ffffff06', borderBottom: '1px solid #ffffff06' }}>
        <div style={s.sectionInner}>
          ...
          <h2 style={s.sectionTitle}>An AI investigator<br />running your case.</h2>
          <p style={s.sectionBody}>
            N=1 isn't a habit tracker. It's an autonomous investigator that designs your trial, monitors it daily, and separates the signal from the noise.
          </p>
            ...
            {[
              {
                ...
                body: 'Tell us what you suspect. "Sugar causes my breakouts." We take it from there.',
                accent: '#fb923c',
              },
              {
                num: '02',
                title: 'We design the protocol',
                body: 'The agent surfaces hidden variables and builds a customized trial like protocol around your real life.',
                accent: '#818cf8',
              },
              {
                num: '03',
                title: 'Daily monitoring',
                body: 'Your agent checks in daily, tracking adherence and flagging confounders to keep your data clean.',
                accent: '#4ade80',
              },
              {
                num: '04',
                title: 'Calibrated truth',
                body: 'Get a plain-language summary of what your data might be saying.',
                accent: '#c084fc',
              },
            ].map((step, i) => (
              <div key={i} style={s.step}>
      ...
      <section style={s.section}>
        <div style={s.sectionInner}>
          ...
          <div style={s.forCards}>
            {[
              'You\'ve tried a dozen routines and still can\'t isolate what triggers your symptoms',
              'You sleep eight hours but wake up exhausted',
              'Your digestion or energy levels are unpredictable, with no obvious pattern',
              'You\'ve been through the medical system and left without a useful answer',
            ].map((text, i) => (
              <div key={i} style={s.forCard}>
                <div style={s.forDot} />
